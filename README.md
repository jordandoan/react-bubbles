...
A token is used for authorization, usually received when you log in. Authorization allows the user to perform certain tasks they couldn't do if they were not signed in. 
- [ ] What steps can you take in your web apps to keep your data secure?  
Authentication and authorization are good ways to keep your website secure. With authorization, you can block people from viewing your data through your API. You can also create private routes on your app, which prevent unauthorized users from viewing routes and interacting with your app. 
- [ ] Describe how web servers work.  
When going to a URL, it is translated to an IP through your browser and goes to a web server, and makes an HTTP request for the data that it's hosting. You will receive a mixture of HTML, CSS, and JS files, which all work together to create the web page you see!  
